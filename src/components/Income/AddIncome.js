...
const AddIncome = () => {
  ...
  const [formatNewDate, setFormatNewDate] = useState("");
  ...
  const saveIncome = async(event) => {
    ...
    try {
      ...
      Swal.fire("New Income Added", " ", "success");
            ...
            <div className="u-layout-row">
              ...
              <div className="u-align-center u-container-style u-layout-cell u-size-32 u-white u-layout-cell-2">
                <div className="u-container-layout u-container-layout-2">
                  <Link className="u-border-2 u-border-grey-75 u-btn u-button-style u-none u-btn-1" to="/income">
                    View All Incomes
                  </Link>
                  <div className="u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-form u-form-1">
                    <form onSubmit={saveIncome} className="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" style={{ padding: '0px' }} name="form">
                      ...
                      <div className="u-form-group u-form-textarea u-label-none u-form-group-3">
                        ...
                        placeholder="Other Income Detail" rows="2" cols="50" id="otherExpenseDetail" className="u-border-2 u-border-grey-10 u-grey-10 u-input u-input-rectangle u-input-3">
                        </textarea>
                      </div>
                      ...
                      <div className="u-align-right u-form-group u-form-submit u-label-none u-form-group-4">
                        <button className="u-active-palette-1-base u-border-active-palette-2-light-2 u-border-hover-palette-2-light-2 u-border-none u-btn u-btn-round u-btn-submit u-button-style u-hover-palette-1-dark-2 u-palette-1-light-1 u-radius-8 u-btn-2">ADD INCOME</button>
